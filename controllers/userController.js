...
async function deleteUserData(user,role) {
    ...
    if(role === 'user'){
        ...
        for(let i=0; i< appliedJobs.length;i++){
            ...
            appliedJobs[i].applicantsApplied.slice(appliedJobs[i].applicantsApplied.indexOf(obj.id))
